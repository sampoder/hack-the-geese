          ...
          <div className="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div className="inline-block min-w-full py-2 align-middle ">
              <div className="overflow-hidden shadow ring-1 ring-black ring-opacity-5 sm:rounded-lg dark:bg-gray-700">
                <table className="min-w-full sm:px-6 lg:px-8">
                  ...
                  <tbody className="divide-y divide-gray-200 bg-white dark:bg-gray-800 dark:divide-gray-600">
                    {data && data.map((person: Person) => (
                      <tr key={person.id}>
                        <td className="whitespace-nowrap py-4 pl-4 flex pr-3 text-sm font-medium items-center justify-start text-gray-900 sm:pl-6 dark:text-gray-100" style={{ gap: '8px'}}>
                          {person.goose && <img src={`data:image/svg+xml;base64,${person.goose}`} style={{height: '50px'}} />}
                          {person.id}
                        </td>
                        <td
